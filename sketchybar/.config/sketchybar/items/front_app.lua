...
if wm.type == "aerospace" then
    ...
    local function normalize_workspace(workspace)
        ...
        if workspace > 10 then return workspace - 10 end
        return workspace
    end
    ...
    -- Move front_app after spaces are initialized
    ...
    front_app:subscribe("front_app_switched", function(env)
        ...
        if current_app_name == "" then return end
        if lock_exists() then return end
        if current_workspace then set_label() else refresh_workspace_and_label() end
    end)
...
-- ===========================================================================
-- Paneru / no WM: just show app name, no workspace prefix
-- ===========================================================================
