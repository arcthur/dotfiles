...
brew "ast-grep"     # Code structural search
brew "carapace"     # Multi-shell argument completer
brew "aichat"       # All-in-one AI CLI tool
...
brew "bd"           # A memory upgrade for your coding agent
